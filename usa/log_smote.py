# -*- coding: utf-8 -*-
"""
Created on Fri Nov 14 19:28:33 2025
...
df_metrics.to_csv("metriche_logistica_smote_american_kaggle.csv", index=False)
...
plt.title("Matrice di Confusione - Logistic Regression (SMOTE")
plt.tight_layout()
plt.show()
...
plt.title('Curva ROC - Logistic Regression (SMOTE')
