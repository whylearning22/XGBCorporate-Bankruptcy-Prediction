# -*- coding: utf-8 -*-
"""
Created on Mon Oct 27 17:12:40 2025
...
from imblearn.pipeline import Pipeline as ImbPipeline  # pipeline di imblearn
...
# -------------------------------
# Modello Logistic Regression + SMOTE
# -------------------------------
...
p_grid = {'clf__C': [0.01, 0.1, 1, 10, 100]}
...
df_metrics.to_csv("metriche_LR_SMOTE_outlier_taiwan.csv", index=False)
...
plt.title("Matrice di Confusione - LR + SMOTE + Outlier (OOF)")
plt.tight_layout()
plt.show()
...
plt.title('Curva ROC - LR + SMOTE + Outlier (Nested CV)')
plt.legend(loc='lower right')
plt.tight_layout()
plt.show()

print("Ultimo best params (CV interna):", clf.best_params_)
