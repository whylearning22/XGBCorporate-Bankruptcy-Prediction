# -*- coding: utf-8 -*-
"""
Created on Mon Oct 27 16:54:30 2025
...
# -------------------------------
# Modello + griglia iperparametri (Random Forest)
# -------------------------------
...
df_metrics.to_csv("metriche_RF_taiwan_out.csv", index=False)
...
plt.title("Matrice di Confusione - Nested CV (OOF)")
plt.tight_layout()
plt.show()
...
plt.title('Curva ROC - RF Nested CV (OOF)')
