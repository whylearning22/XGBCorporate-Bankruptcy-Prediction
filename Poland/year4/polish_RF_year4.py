# -*- coding: utf-8 -*-
"""
Created on Sun Oct 26 17:15:34 2025
...
# Modello base: Random Forest bilanciata
...
# Pipeline: imputazione -> scaling -> RF
pipe = Pipeline([
...
df_metrics.to_csv("metriche_rf_year4_polish.csv", index=False)
...
plt.title("Matrice di Confusione - Random Forest (Year=4)")
plt.tight_layout()
plt.show()
...
plt.title('Curva ROC - Random Forest (Year=4)')
