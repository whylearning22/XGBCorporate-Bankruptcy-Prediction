# -*- coding: utf-8 -*-
"""
Created on Sun Oct 26 17:39:52 2025
...
df_metrics.to_csv("metriche_rf_year3_polish.csv", index=False)
...
plt.title("Matrice di Confusione - Random Forest (Year=3)")
plt.tight_layout()
plt.show()
...
plt.title('Curva ROC - Random Forest (Year=3)')
