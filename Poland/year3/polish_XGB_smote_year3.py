# -*- coding: utf-8 -*-
"""
Created on Mon Oct 27 12:50:00 2025
...
df_metrics.to_csv("metriche_xgboost_smote_year3_polish.csv", index=False)
...
plt.title("Matrice di Confusione - XGBoost (Year=3, SMOTE)")
plt.tight_layout()
plt.show()
...
plt.title('Curva ROC - XGBoost (Year=3, SMOTE)')
