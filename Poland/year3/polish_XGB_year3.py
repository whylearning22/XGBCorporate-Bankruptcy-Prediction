# -*- coding: utf-8 -*-
"""
Created on Sun Oct 26 22:46:00 2025
...
df_metrics.to_csv("metriche_xgboost_year3_polish.csv", index=False)
...
df_importances_top.to_csv("feature_importance_top20_xgboost_year3_polish.csv", index=False)
...
plt.ylabel("Feature")
plt.title(f"Top {top_n} XGBoost Feature Importances (Mean over 10 folds, Year=3)")
...
plt.title("Matrice di Confusione - XGBoost (Year=3)")
plt.tight_layout()
plt.show()
...
plt.title('Curva ROC - XGBoost (Year=3)')
