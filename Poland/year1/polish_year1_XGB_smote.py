# -*- coding: utf-8 -*-
"""
Created on Sat Oct 25 13:28:16 2025
...
# Modello XGB (senza pesi di classe)
xgb = XGBClassifier(
    random_state=seed,
    n_jobs=-1,
    eval_metric='logloss',
...
df_metrics.to_csv("metriche_xgboost_smote_year1_polish.csv", index=False)
...
plt.title("Matrice di Confusione - XGBoost (Year=1, SMOTE)")
plt.tight_layout()
plt.show()
...
plt.title('Curva ROC - XGBoost (Year=1, SMOTE)')
