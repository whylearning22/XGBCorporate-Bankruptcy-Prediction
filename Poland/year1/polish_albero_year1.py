# -*- coding: utf-8 -*-
"""
Created on Sun Oct 26 11:53:02 2025
...
df_metrics.to_csv("metriche_dt_year1_polish.csv", index=False)
...
plt.title("Matrice di Confusione - Decision Tree (Year=1)")
plt.tight_layout()
plt.show()
...
plt.title('Curva ROC - Decision Tree (Year=1)')
