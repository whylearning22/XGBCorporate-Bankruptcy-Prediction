# -*- coding: utf-8 -*-
"""
Created on Sun Oct 26 13:02:04 2025
...
df_metrics.to_csv("metriche_rf_year1_polish.csv", index=False)
...
plt.title("Matrice di Confusione - Random Forest (Year=1)")
plt.tight_layout()
plt.show()
...
plt.title('Curva ROC - Random Forest (Year=1)')
