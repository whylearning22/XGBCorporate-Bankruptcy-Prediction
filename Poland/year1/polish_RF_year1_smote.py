# -*- coding: utf-8 -*-
"""
Created on Sun Oct 26 13:47:16 2025
...
# Dataset (es. year=5; cambia se serve)
...
# Pipeline: imputazione -> scaling -> SMOTE -> RF
pipe = Pipeline([
...
df_metrics.to_csv("metriche_rf_smote_year1_polish.csv", index=False)
...
plt.title("Matrice di Confusione - Random Forest (Year=1, SMOTE)")
plt.tight_layout()
plt.show()
...
plt.title('Curva ROC - Random Forest (Year=1, SMOTE)')
