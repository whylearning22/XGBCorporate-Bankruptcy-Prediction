# -*- coding: utf-8 -*-
"""
Created on Tue Oct  7 17:13:45 2025
...
gs = GridSearchCV(
    ...
    cv=inner_cv,
    scoring='recall',  # obiettivo: massimizzare recall (puoi cambiare)
    n_jobs=-1,
    refit=True
)
...
df_metrics.to_csv("metriche_logistica_year1_polish.csv", index=False)
...
plt.title("Matrice di Confusione - Logistic Regression (Year=1)")
plt.tight_layout()
plt.show()
...
plt.title('Curva ROC - Logistic Regression (Year=1)')
