# -*- coding: utf-8 -*-
"""
Created on Tue Oct  7 18:17:25 2025
...
df_metrics.to_csv("metriche_xgboost_year1_polish.csv", index=False)
...
df_importances_top.to_csv("feature_importance_top20_xgboost_year1_polish.csv", index=False)
...
plt.ylabel("Feature")
plt.title(f"Top {top_n} XGBoost Feature Importances (Year=1)")
...
plt.title("Matrice di Confusione - XGBoost (Year=1)")
plt.tight_layout()
plt.show()
...
plt.title('Curva ROC - XGBoost (Year=1)')
