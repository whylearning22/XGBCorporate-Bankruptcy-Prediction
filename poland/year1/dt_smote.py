# -*- coding: utf-8 -*-
"""
Created on Sun Oct 26 12:29:30 2025
...
df_metrics.to_csv("metriche_dt_smote_year1_polish.csv", index=False)
...
plt.title("Matrice di Confusione - Decision Tree (Year=1, SMOTE)")
plt.tight_layout()
plt.show()
...
plt.title('Curva ROC - Decision Tree (Year=1, SMOTE)')
