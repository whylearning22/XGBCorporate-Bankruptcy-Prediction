# -*- coding: utf-8 -*-
"""
Created on Sat Oct 25 12:26:13 2025
...
# Logistic Regression SENZA class_weight
...
df_metrics.to_csv("metriche_logreg_smote_year1_polish.csv", index=False)
...
plt.title("Matrice di Confusione - Logistic Regression (Year=1, SMOTE)")
plt.tight_layout()
plt.show()
...
plt.title('Curva ROC - Logistic Regression (Year=1, SMOTE)')
