# -*- coding: utf-8 -*-
"""
Created on Sun Oct 26 19:31:06 2025
...
df_metrics.to_csv("metriche_logreg_smote_year4_polish.csv", index=False)
...
plt.title("Matrice di Confusione - Logistic Regression (Year=4, SMOTE)")
plt.tight_layout()
plt.show()
...
plt.title('Curva ROC - Logistic Regression (Year=4, SMOTE)')
