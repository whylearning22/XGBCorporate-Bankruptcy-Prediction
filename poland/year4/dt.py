# -*- coding: utf-8 -*-
"""
Created on Sun Oct 26 21:57:07 2025
...
# Griglia iperparametri (come da richiesta)
...
# Modello base: Decision Tree bilanciato
dt = DecisionTreeClassifier(
    random_state=seed,
    class_weight='balanced'
)

# Pipeline: imputazione -> scaling -> modello
pipe = Pipeline([
...
df_metrics.to_csv("metriche_dt_year4_polish.csv", index=False)
...
plt.title("Matrice di Confusione - Decision Tree (Year=4)")
plt.tight_layout()
plt.show()
...
plt.title('Curva ROC - Decision Tree (Year=4)')
