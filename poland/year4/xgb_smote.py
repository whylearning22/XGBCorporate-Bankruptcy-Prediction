# -*- coding: utf-8 -*-
"""
Created on Mon Oct 27 14:25:48 2025
...
df_metrics.to_csv("metriche_xgboost_smote_year4_polish.csv", index=False)
...
plt.title("Matrice di Confusione - XGBoost (Year=4, SMOTE)")
plt.tight_layout()
plt.show()
...
plt.title('Curva ROC - XGBoost (Year=4, SMOTE)')
