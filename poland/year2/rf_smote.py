# -*- coding: utf-8 -*-
"""
Created on Sun Oct 26 14:34:52 2025
...
df_metrics.to_csv("metriche_rf_smote_year2_polish.csv", index=False)
...
plt.title("Matrice di Confusione - Random Forest (Year=2, SMOTE)")
plt.tight_layout()
plt.show()
...
plt.title('Curva ROC - Random Forest (Year=2, SMOTE)')
