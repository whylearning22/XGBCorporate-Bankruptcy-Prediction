# -*- coding: utf-8 -*-
"""
Created on Sun Oct 26 18:01:41 2025
...
df_metrics.to_csv("metriche_rf_year2_polish_out.csv", index=False)
...
plt.title("Matrice di Confusione - Random Forest (Year=2)")
plt.tight_layout()
plt.show()
...
plt.title('Curva ROC - Random Forest (Year=2)')
