# -*- coding: utf-8 -*-
"""
Created on Thu Oct 23 19:48:01 2025
...
df_metrics.to_csv("metriche_logistica_year2_polish.csv", index=False)
...
plt.title("Matrice di Confusione - Logistic Regression (Year=2)")
plt.tight_layout()
plt.show()
...
plt.title('Curva ROC - Logistic Regression (Year=2)')
