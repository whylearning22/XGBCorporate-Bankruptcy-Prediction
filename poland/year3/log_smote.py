# -*- coding: utf-8 -*-
"""
Created on Sun Oct 26 19:23:10 2025
...
df_metrics.to_csv("metriche_logreg_smote_year3_polish.csv", index=False)
...
plt.title("Matrice di Confusione - Logistic Regression (Year=3, SMOTE)")
plt.tight_layout()
plt.show()
...
plt.title('Curva ROC - Logistic Regression (Year=3, SMOTE)')
