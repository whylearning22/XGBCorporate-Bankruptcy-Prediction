# -*- coding: utf-8 -*-
"""
Created on Sun Oct 26 20:30:09 2025
...
# Griglia iperparametri (come richiesto)
...
df_metrics.to_csv("metriche_dt_smote_year3_polish.csv", index=False)
...
plt.title("Matrice di Confusione - Decision Tree (Year=3, SMOTE)")
plt.tight_layout()
plt.show()
...
plt.title('Curva ROC - Decision Tree (Year=3, SMOTE)')
