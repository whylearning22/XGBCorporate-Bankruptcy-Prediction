# -*- coding: utf-8 -*-
"""
Created on Fri Nov 14 19:37:34 2025
...
# -------------------------------
# 2) Modello + griglia iperparametri (Decision Tree)
# -------------------------------
dt_inner = DecisionTreeClassifier(
    random_state=seed,
...
df_metrics.to_csv("metriche_albero_smote_american_kaggle.csv", index=False)
...
plt.title("Matrice di Confusione - Decision Tree (Smote)")
plt.tight_layout()
plt.show()
...
plt.title('Curva ROC - Decision Tree (Smote)')
